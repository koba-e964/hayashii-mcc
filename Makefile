SAMPLES = sample/ack.ml sample/add.ml sample/adder.ml \
sample/cond.ml sample/constexpr.ml sample/even-odd.ml \
sample/fib.ml sample/float-easy.ml sample/float.ml sample/funcomp.ml sample/gcd.ml \
...
sample/matmul-flat.ml sample/matmul.ml sample/non-tail-if.ml sample/non-tail-if2.ml sample/print.ml \
...
%.test : %.ml
	LANG=C.UTF-8 cabal run <$*.ml >/dev/null
